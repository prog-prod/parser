...
class CreateStockCompanyProfileHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stock_company_profile_histories', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(\App\Models\Stock::class);
            $table->foreignIdFor(\App\Models\StockCompanyProfile::class);
    ...
    {
        Schema::dropIfExists('stock_company_profile_histories');
    }
}
